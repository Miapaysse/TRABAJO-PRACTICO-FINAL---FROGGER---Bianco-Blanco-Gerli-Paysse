...
static Level level1={
    ...
    NULL, 
    {
        {NO_CHECKPOINT, START, 0, 0, 0, 0, DIR_LEFT},
        {NO_CHECKPOINT, START, 0, 0, 0, 0, DIR_LEFT},

        {NO_CHECKPOINT, ROAD, 2, TRUCK_LENGTH, MEDIUM_GAP, SLOW, DIR_RIGHT},
        {NO_CHECKPOINT, ROAD, 2, CAR_LENGTH, MEDIUM_GAP, SLOW, DIR_LEFT},
        {NO_CHECKPOINT, ROAD, 3, CAR_LENGTH, MEDIUM_GAP, SLOW, DIR_RIGHT},
        {NO_CHECKPOINT, ROAD, 2, CAR_LENGTH, MEDIUM_GAP, SLOW, DIR_LEFT},
        {NO_CHECKPOINT, ROAD, 2, CAR_LENGTH, MEDIUM_GAP, MEDIUM_SPEED, DIR_RIGHT},

        {CHECKPOINT_1, SAFE, 0, 0, 0, 0, DIR_LEFT},
        {NO_CHECKPOINT, SAFE, 0, 0, 0, 0, DIR_LEFT},

        {NO_CHECKPOINT, WATER, 4, MEDIUM, MEDIUM_GAP, SLOW, DIR_LEFT},
        {NO_CHECKPOINT, WATER, 2, SMALL, MEDIUM_GAP, SLOW, DIR_RIGHT},
        {NO_CHECKPOINT, WATER, 2, LARGE, MEDIUM_GAP, SLOW, DIR_LEFT},
        {NO_CHECKPOINT, WATER, 2, MEDIUM, MEDIUM_GAP, SLOW, DIR_RIGHT},
        {NO_CHECKPOINT, WATER, 2, LARGE, MEDIUM_GAP, MEDIUM_SPEED, DIR_LEFT},

        {CHECKPOINT_2, SAFE, 0, 0, 0, 0, DIR_LEFT},
        {NO_CHECKPOINT, SAFE, 0, 0, 0, 0, DIR_LEFT}
    }
};
...
static Level level2={
    ...
    NULL, 
    {
        ...
        {NO_CHECKPOINT, ROAD, 3, CAR_LENGTH, MEDIUM_GAP, SLOW, DIR_RIGHT},
        {NO_CHECKPOINT, ROAD, 2, CAR_LENGTH, MAX_GAP, MEDIUM_SPEED, DIR_LEFT},
        {NO_CHECKPOINT, ROAD, 2, TRUCK_LENGTH, MAX_GAP, MEDIUM_SPEED, DIR_RIGHT},
        {NO_CHECKPOINT, ROAD, 3, CAR_LENGTH, MEDIUM_GAP, MEDIUM_SPEED, DIR_LEFT},
        {NO_CHECKPOINT, ROAD, 4, TRUCK_LENGTH, MIN_GAP, SLOW, DIR_RIGHT},

        {CHECKPOINT_1, SAFE, 0, 0, 0, 0, DIR_LEFT},
        {CHECKPOINT_1, SAFE, 0, 0, 0, 0, DIR_LEFT},

        {NO_CHECKPOINT, WATER, 3, MEDIUM, MEDIUM_GAP, SLOW, DIR_LEFT},
        {NO_CHECKPOINT, WATER, 4, SMALL, MEDIUM_GAP, FAST, DIR_RIGHT},
        {NO_CHECKPOINT, WATER, 3, LARGE, MAX_GAP, MEDIUM_SPEED, DIR_LEFT},
        {NO_CHECKPOINT, WATER, 4, MEDIUM, MAX_GAP, SLOW, DIR_RIGHT},
        {NO_CHECKPOINT, WATER, 3, LARGE, MEDIUM_GAP, MEDIUM_SPEED, DIR_LEFT},
...
static Level level3={
    ...
    NULL, 
    {
        ...
        {NO_CHECKPOINT, ROAD, 3, CAR_LENGTH, MEDIUM_GAP, MEDIUM_SPEED, DIR_RIGHT},
        {NO_CHECKPOINT, ROAD, 2, CAR_LENGTH, MAX_GAP, FAST, DIR_LEFT},
        {NO_CHECKPOINT, ROAD, 2, TRUCK_LENGTH, MAX_GAP, MEDIUM_SPEED, DIR_RIGHT},
        {NO_CHECKPOINT, ROAD, 3, CAR_LENGTH, MEDIUM_GAP, MEDIUM_SPEED, DIR_LEFT},
        {NO_CHECKPOINT, ROAD, 4, TRUCK_LENGTH, MIN_GAP, SLOW, DIR_RIGHT},
        ...
        {NO_CHECKPOINT, WATER, 3, MEDIUM, MEDIUM_GAP, MEDIUM_SPEED, DIR_LEFT},
        {NO_CHECKPOINT, WATER, 4, SMALL, MAX_GAP, FAST, DIR_RIGHT},
        {NO_CHECKPOINT, WATER, 2, MEDIUM, MEDIUM_GAP, MEDIUM_SPEED, DIR_LEFT},
        {NO_CHECKPOINT, WATER, 3, MEDIUM, MEDIUM_GAP, FAST, DIR_RIGHT},
        {NO_CHECKPOINT, WATER, 1, LARGE, MEDIUM_GAP, MEDIUM_SPEED, DIR_LEFT},
