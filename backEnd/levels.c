...
static Level level1={
    ...
    NULL, 
    {
        {NO_CHECKPOINT, NULL,NONE,START, 0, 0, 0, 0, DIR_LEFT},
        {NO_CHECKPOINT, NULL,NONE,START, 0, 0, 0, 0, DIR_LEFT},
        ...
        {CHECKPOINT_1, NULL,NONE,SAFE, 0, 0, 0, 0, DIR_LEFT},
        {CHECKPOINT_1, NULL,NONE,SAFE, 0, 0, 0, 0, DIR_LEFT},
        ...
        {CHECKPOINT_FINISH_LINE, NULL,NONE,SAFE, 0, 0, 3, 0,},
        {NO_CHECKPOINT, NULL,NONE,SAFE, 0,}
...
static Level level2={
    ...
    NULL, 
    {
        ...
        {CHECKPOINT_FINISH_LINE, NULL, NONE,SAFE, 0, 0, 3, 0, DIR_LEFT},
        {NO_CHECKPOINT, NULL, NONE,SAFE, 0, 0, 0, 0, DIR_LEFT}
    },
    {
        {1, 1, false},
        {4, 1, false},
