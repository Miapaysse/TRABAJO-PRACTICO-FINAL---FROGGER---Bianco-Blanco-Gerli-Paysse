...
static Level level1={
    ...
    NULL, 
    {
        ...
        {NULL, ROAD, 2, CAR_LENGTH, MEDIUM_GAP, SLOW, DIR_LEFT},
        {NULL, ROAD, 2, CAR_LENGTH, MEDIUM_GAP, MEDIUM_SPEED, DIR_RIGHT},

        {NULL, SAFE, 0, 0, 0, 0, DIR_LEFT},
        {NULL, SAFE, 0, 0, 0, 0, DIR_LEFT},

        {NULL, WATER, 4, MEDIUM, MEDIUM_GAP, SLOW, DIR_LEFT},
        ...
        {NULL, WATER, 2, LARGE, MEDIUM_GAP, MEDIUM_SPEED, DIR_LEFT},
...
static Level level2={
    ...
    NULL, 
    {
        ...
        {NULL, ROAD, 3, CAR_LENGTH, MEDIUM_GAP, SLOW, DIR_RIGHT},
        {NULL, ROAD, 2, CAR_LENGTH, MAX_GAP, MEDIUM_SPEED, DIR_LEFT},
        {NULL, ROAD, 2, TRUCK_LENGTH, MAX_GAP, MEDIUM_SPEED, DIR_RIGHT},
        {NULL, ROAD, 3, CAR_LENGTH, MEDIUM_GAP, MEDIUM_SPEED, DIR_LEFT},
        {NULL, ROAD, 4, TRUCK_LENGTH, MIN_GAP, SLOW, DIR_RIGHT},

        {NULL, SAFE, 0, 0, 0, 0, DIR_LEFT},
        {NULL, SAFE, 0, 0, 0, 0, DIR_LEFT},

        {NULL, WATER, 3, MEDIUM, MEDIUM_GAP, SLOW, DIR_LEFT},
        {NULL, WATER, 4, SMALL, MEDIUM_GAP, FAST, DIR_RIGHT},
        {NULL, WATER, 3, LARGE, MAX_GAP, MEDIUM_SPEED, DIR_LEFT},
        {NULL, WATER, 4, MEDIUM, MAX_GAP, SLOW, DIR_RIGHT},
...
static Level level3={
    ...
    NULL, 
    {
        ...
        {NULL, ROAD, 2, CAR_LENGTH, MAX_GAP, FAST, DIR_LEFT},
        {NULL, ROAD, 2, TRUCK_LENGTH, MAX_GAP, MEDIUM_SPEED, DIR_RIGHT},
        {NULL, ROAD, 3, CAR_LENGTH, MEDIUM_GAP, MEDIUM_SPEED, DIR_LEFT},
        {NULL, ROAD, 4, TRUCK_LENGTH, MIN_GAP, SLOW, DIR_RIGHT},
        ...
        {NULL, WATER, 4, SMALL, MAX_GAP, FAST, DIR_RIGHT},
        {NULL, WATER, 2, MEDIUM, MEDIUM_GAP, MEDIUM_SPEED, DIR_LEFT},
        {NULL, WATER, 3, MEDIUM, MEDIUM_GAP, FAST, DIR_RIGHT},
        {NULL, WATER, 1, LARGE, MEDIUM_GAP, MEDIUM_SPEED, DIR_LEFT},
