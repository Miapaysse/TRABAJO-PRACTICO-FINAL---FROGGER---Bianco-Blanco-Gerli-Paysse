...
#define ENTITY_UPDATE_PERIOD 0.15
...
typedef enum{
  ...
  ERR_INVALID_OBSTACLE_COUNT,
   ...
   ERR_ALLEGRO_INIT_FAILED,
   ERR_DISPLAY_INIT_FAILED,
   ERR_KEYBOARD_INIT_FAILED,
   ERR_IMAGE_ADDON_FAILED,
   ERR_PRIMITIVES_ADDON_FAILED,
   ERR_FONT_ADDON_FAILED,
   ERR_EVENT_QUEUE_FAILED,
   ERR_INIT_TTF_FAILED,
   ERR_LOAD_IMAGES_FAILED,
   ERR_LOAD_FONTS_FAILED,
   ERR_FILE_TOP10_FAILED,
